...
// protect main "decoding and playing" loop
	...
	c_SoundTouchProcessor.SetOutputProcessor(&c_OutputProcessor);
...
// PNG helper functions removed for Lite version
...
// JPEG support removed for Lite version
