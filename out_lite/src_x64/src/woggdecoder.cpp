...
const wchar_t *g_ogg_error_strW[DECODER_UNKNOWN_ERROR + 1] = {
	L"No error.",
...
int WOggDecoder::Initialize(INT_PTR param1, INT_PTR param2, INT_PTR param3, INT_PTR param4)
{
