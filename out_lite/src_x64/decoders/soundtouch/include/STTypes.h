...
//#undef FLOAT_SAMPLES
    ...
    #if (defined(WIN32) || defined(_WIN32) || defined(__i386__) || defined(__x86_64__) || defined(_M_X64) || defined(_M_IX86)) && !defined(_M_ARM64) && !defined(__aarch64__)
    ...
    #define ALLOW_NONEXACT_SIMD_OPTIMIZATION    1
        ...
        typedef long  LONG_SAMPLETYPE;
            ...
            // Allow MMX optimizations (not available on x64)
