...
virtual int __stdcall SetFFTGraphParam(TFFTGraphParamID nParamID, intptr_t nValue) = 0;
virtual intptr_t __stdcall GetFFTGraphParam(TFFTGraphParamID nParamID) = 0;
...
W_DECLSPEC int __stdcall zplay_SetFFTGraphParam(ZPLAY_HANDLE handle, TFFTGraphParamID nParamID, intptr_t nParamValue);
W_DECLSPEC intptr_t __stdcall zplay_GetFFTGraphParam(ZPLAY_HANDLE handle, TFFTGraphParamID nParamID);
