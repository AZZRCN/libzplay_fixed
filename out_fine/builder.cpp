...
// C++ Parallel Build System for out_fine - MSVC compatible
...
private:
    ...
    void printHeader(size_t total) const {
        printf("\n");
        printf("======================================================================\n");
        printf("  libzplay Fine C++ Parallel Builder v2.0\n");
        printf("======================================================================\n");
        ...
        printf("  Output: out/<compiler>/<crt>/<arch>/<type>/-<opt>\n");
        printf("======================================================================\n\n");
    }
    ...
    void writeLog(const std::vector<BuildResult>& results) const {
        ...
        log << "libzplay Fine Detailed Build Log - " << results.size() << " configs\n";
        log << "================================================\n\n";
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (arg == "-h" || arg == "--help") {
            printf("Usage: builder [-p N] [-j N]\n  -p N  parallel builds (default 3)\n  -j N  threads per build (default 16)\n");
            return 0;
        }
    }
