...
typedef struct {
	...
	const char *pchStreamDescription;		// stream description
} INPUT_STREAM_INFO;
...
class WAudioDecoder {
public:
    virtual ~WAudioDecoder() {}
//==============================================
	// initialize decoder, call before you use decoder
	virtual int  Initialize(INT_PTR param1, INT_PTR param2, INT_PTR param3, INT_PTR param4) = 0;
