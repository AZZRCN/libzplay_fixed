...
void WSpectrum::alpha_blend()
{
	...
	{															
		BYTE *pbDestRGB = (BYTE*) ((DWORD*) c_pDestBits + ( j * c_nWidth));
		BYTE *pbSrcRGB = (BYTE*) ((DWORD*) c_pSrcBits + ( j * c_nWidth));
...
int WSpectrum::SetBgBitmap(HBITMAP hbm)
{
	...
	{
		if(c_bgExternBitmap)
			return (INT_PTR) c_bgExternBitmap;

		return (INT_PTR) c_bgBitmap;
	}
