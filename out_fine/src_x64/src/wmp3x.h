...
class  WMp3x : public ZPlay {
	public:
		...
		int __stdcall SetFFTGraphParam(TFFTGraphParamID nParamID, intptr_t nValue);
		intptr_t __stdcall GetFFTGraphParam(TFFTGraphParamID nParamID);
...
// CALLBACK MESSAGE PROCESSING
	...
	static int send_callback_message(WMp3x *instance, unsigned int message, UINT_PTR param1, UINT_PTR param2);
	int c_callback_ret;
